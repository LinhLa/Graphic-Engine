...
typedef std::unordered_map<
	...
	MyCustomDynamicAlloc<std::pair<const std::string, GameObject*>>> GameObjectNodeTableType;

typedef std::list<GameObject*, MyCustomAlloc<GameObject*>> SceneGraphType;
enum UI_TYPE : int8_t
{
	NODE_TYPE_START = -1,
	NODE_2D_IMAGE_TYPE,
...
class GameObject: public Property, public NodeResourceProperty
{
protected:

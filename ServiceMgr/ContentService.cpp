...
ContentService::ContentService() :m_pRabbit(new Rabbit)
{
	...
	m_pRenderCallback.reset(new function_member<ContentService, RenderDrawArgumentType>(this, &ContentService::onDraw));
	m_pKeyInputCallback.reset(new function_member<ContentService, KeyInputArgumentType>(this, &ContentService::onKeyInputEvent));
}

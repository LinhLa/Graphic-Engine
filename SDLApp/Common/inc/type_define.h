...
typedef queue_protected<Task*, std::allocator<Task*>, TaskDetruction> listTaskType;
typedef std::list<IService*> listServiceType;
typedef queue_protected<Message> messageQueueType;
...
class function_base;
typedef std::list<function_base*> listCallbackType;

typedef uint64_t message_id;
typedef std::map<message_id, listCallbackType>	dictionaryCallbackType;
